...
public class ImageRenderer implements GLSurfaceView.Renderer {
    ...
    public ImageRenderer(InputStream open) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        int vertexShader = GLESUtils.createVertexShader(VERTEX_SHADER);//加载顶点着色器
        int fragmentShader = GLESUtils.createFragmentShader(FRAGMENT_SHADER);//加载碎片着色器
