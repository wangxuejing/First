...
public final class GLESUtils {
    ...
    public static FloatBuffer createDirectBuffer(float[] coords) {
    ...
    public static FloatBuffer convert2DirectBuffer(FloatBuffer coords) {
        // Allocate a direct ByteBuffer, using 4 bytes per float, and copy coords into it.
        ByteBuffer bb = ByteBuffer.allocateDirect(coords.array().length * SIZEOF_FLOAT);
        bb.order(ByteOrder.nativeOrder());
        FloatBuffer fb = bb.asFloatBuffer();
        fb.put(coords.array());
        fb.position(0);
    ...
    public static IntBuffer createDirectBuffer(int[] coords) {
        // Allocate a direct ByteBuffer, using 4 bytes per float, and copy coords into it.
        ByteBuffer bb = ByteBuffer.allocateDirect(coords.length * SIZEOF_FLOAT);
        bb.order(ByteOrder.nativeOrder());
