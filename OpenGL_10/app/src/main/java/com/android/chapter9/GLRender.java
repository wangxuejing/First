...
import static com.android.GLESUtils.convert2DirectBuffer;
	...
	private void drawList(GL10 gl)
	{
		...
		for (yloop=1;yloop<6;yloop++)
		{
			for (xloop=0;xloop<yloop;xloop++)
			{
				...
				// 设置顶点数组
				gl.glVertexPointer(3, GL10.GL_FLOAT, 0, convert2DirectBuffer(boxVertices));
				// 设置纹理坐标数组
				gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, convert2DirectBuffer(boxTexCoords));
				...
				// 设置顶点数组
				gl.glVertexPointer(3, GL10.GL_FLOAT, 0, convert2DirectBuffer(topVertices));
				// 设置纹理坐标数组
				gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, convert2DirectBuffer(topTexCoords));
				// 绘制
				gl.glDrawArrays(GL10.GL_TRIANGLE_FAN, 0, 4);
			}
		}
