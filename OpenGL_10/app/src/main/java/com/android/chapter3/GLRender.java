...
public class GLRender implements Renderer
{
	...
	public void onDrawFrame(GL10 gl)
	{
		...
		//设置颜色数组
		gl.glColorPointer(4, GL10.GL_FIXED, 0, createDirectBuffer(colorBuffer));
		
		// 设置三角形的顶点数据
		gl.glVertexPointer(3, GL10.GL_FIXED, 0, createDirectBuffer(triggerBuffer));
	    ...
	    //设置正方形顶点数组
	    gl.glVertexPointer(3, GL10.GL_FIXED, 0, createDirectBuffer(quaterBuffer));
